      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{
          ...
          <button style={{
            background: "none",
            border: "none",
            color: tweet.likes.includes(currentUser?.id) ? "#f91880" : "#71767b",
            display: "flex",
            alignItems: "center",
            gap: 6,
            fontSize: 13,
            ...
            <svg width="18" height="18" viewBox="0 0 24 24" fill={tweet.likes.includes(currentUser?.id) ? "currentColor" : "none"} stroke="currentColor" strokeWidth="1.5">
